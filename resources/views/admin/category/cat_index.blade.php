          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <a href="{{ route('category.create') }}" class="btn btn-primary btn-sm" style="float:right;">Add Categories</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ route('category.delete',$row->id) }}" class="btn btn-danger btn-sm delete">Delete</a>
                    </td>
                  </tr>
                  @endforeach
                  </tbody>
